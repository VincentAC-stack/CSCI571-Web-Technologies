...
public class FavoriteSearchAdapter extends RecyclerView.Adapter<FavoriteSearchAdapter.SearchDataViewHolder> {
    ...
    public FavoriteSearchAdapter(Context context, ArrayList<SearchCard> searchList){
    ...
    public void setData(ArrayList<SearchCard> newData){
        SearchCardList = newData;
    }
